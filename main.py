...
class Main(GridLayout):
    ...
    def train(self, instance): 
        ...
        print(f"your label is: {self.label_input.text}")
        #here must run the hebb algoritm to train the network:
        hebb.train(data, self.label_input.text)

    def test(self, instance):
        prediction = hebb.test(data)
    ...
    def show_train(self):
        ...
        self.divRight.add_widget(Label(text='enter relating label:', size_hint=(1, 0.1)))
        self.label_input = TextInput(multiline=False, size_hint=(1, 0.3), font_size=50, halign='center')
        self.divRight.add_widget(self.label_input)
